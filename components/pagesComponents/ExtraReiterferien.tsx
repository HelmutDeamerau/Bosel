        ...
        <Card className="rounded-2xl shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <section>
              ...
              <p>Die Reiterferien finden ab 8 teilnehmenden Kindern statt. Möchtest du deine Kinder anmelden, drucke bitte das Anmeldeformular aus und schicke  es per Post oder E-Mail ausgefüllt an uns zurück.</p>
            </section>
          </CardContent>
        </Card>
      </motion.div>
